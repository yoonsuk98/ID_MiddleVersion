...
#fixed_quailty factory random number
rf_quality = random.Random(42)
...
class DatasetJPEG(data.Dataset):
    def __init__(self, opt):
        ...
        self.is_color = True#opt['is_color'] if opt['is_color'] else False
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            # quality_factor = rf_quality.randint(1, 7)*10#self.quality_factor
