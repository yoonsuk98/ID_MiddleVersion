...
def define_Dataset(dataset_opt):
    ...
    #  post filter
    # -----------------------------------------
    elif dataset_type in ['nnpf','postfilter']:
        from data.dataset_nnpf import DatasetPostFilter as D

    elif dataset_type in ['nnpf16','postfilter16', 'miv']:
        from data.dataset_nnpf16 import DatasetPostFilter as D
        
    elif dataset_type in ['nnpf16_quater']:
        from data.dataset_nnpf16_quater import DatasetPostFilter as D
    
    elif dataset_type in ['nnpf16_quater_fcm']:
        from data.dataset_nnpf16_quater_fcm import DatasetPostFilter as D

    elif dataset_type in ['nnpf16_cc']:
            from data.dataset_nnpf16_cc import DatasetPostFilter as D
            
    elif dataset_type in ['aapm']:
        from data.dataset_aapm import Datasetaapm as D
    # -----------------------------------------
    # denoising
    # -----------------------------------------
    ...
    #quarternion add
    elif dataset_type in ['dnquarter']:
        from data.dataset_dnquarter import DatasetDnCNN as D
    
    elif dataset_type in ['dehaze']:
        from data.dataset_dehaze import DatasetDehaze as D
    # -----------------------------------------
    # super-resolution
    # -----------------------------------------
