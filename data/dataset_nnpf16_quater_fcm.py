...
class DatasetPostFilter(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            img_H = util.tensor32quaternion_1ch(util.uint162tensor3(img_H))
            img_L = util.tensor32quaternion_1ch(util.uint162tensor3(img_L))
        ...
        # ------------------------------------
            ...
            img_H, img_L = util.single2quaternion_1ch(img_H), util.single2quaternion_1ch(img_L)
